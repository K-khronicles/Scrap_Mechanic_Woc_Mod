...
lootTables.loot_woc_milk = {
	...
	randomLoot = {
		...
		{ uuid = obj_craftbot_craftbot5,			chance = 1 },
		{ uuid = obj_consumable_gas,			chance = 1,		quantity = 40 },
		{ uuid = obj_seed_broccoli,			chance = 1,		quantity = 20 },
		{ uuid = obj_seed_blueberry,			chance = 1,		quantity = 20 },
		{ uuid = obj_seed_orange,			chance = 1,		quantity = 20 },
		{ uuid = obj_seed_pineapple,			chance = 1,		quantity = 20 },
		{ uuid = obj_seed_banana,			chance = 1,		quantity = 20 },
	}
}
